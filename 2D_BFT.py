		...
		for sx in range(2):
			for y in range(rows):
				for x in range(cmesh):
					...
					elements['Router_'+str(x+cmesh*y+rows*cmesh*sx+2*rows*cmesh*sy+4*rows*cmesh*z)] = [0.7]*100
			...
			elements['Router_1_0_'+str(sx+2*sy+4*z)] = [0.7]*100
			elements['TSV_1_0_'+str(sx+2*sy+4*z)] = [0.0005376]*100
			
			elements['Fill_1_5_'+str(sx+2*sy+4*z)] = [0]*100
			elements['Router_1_1_'+str(sx+2*sy+4*z)] = [0.7]*100
